...
const getFileUrl = (fileId) => {
  ...
  if (!appwriteConfig.bucketId) {
    console.error(
      '[share] bucketId undefined in appwriteConfig',
      appwriteConfig
    );
    return null;
  }
  ...
  const url =
    `https://sgp.cloud.appwrite.io/v1/storage/buckets/${appwriteConfig.bucketId}/files/${fileId}/view`;
